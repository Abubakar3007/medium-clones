        ...
        <Layout>
            <>
                ...
                <article className="mb-12">
                    <div className="mx-auto [@media(min-width:900px)]:px-16 [@media(min-width:900px)]:max-w-[1192px]">
                        <div className="max-w-[680px] px-6 mx-auto">
                            <h1 className="text-[42px] leading-[52px] tracking-tight mt-12">
                                <mark className="bg-[#E8F3E8]">Prismio Privacy Policy</mark>
                            </h1>
                            <p className="text-[22px] leading-7 mt-4 mb-6 text-muted-foreground">Effective: September 1, 2020</p>
                            ...
                            <p className="text-lg leading-8 mt-9">
                                <strong><em>You can see our previous Terms here.</em></strong>
                            </p>
                            <p className="text-xl leading-8 mt-9 font-serif">This Privacy Policy explains how A Prismio Corporation (“Prismio,” “we,” or “us”) collects, uses, and discloses information about you. This Privacy Policy applies when you use our websites, mobile applications, and other online products and services that link to this Privacy Policy (collectively, our “Services”), contact our customer service team, engage with us on social media, or otherwise interact with us.</p>
                            <p className="text-xl leading-8 mt-9 font-serif">We may change this Privacy Policy from time to time. If we make changes, we will notify you by revising the date at the top of this policy and, in some cases, we may provide you with additional notice (such as adding a statement to our website or providing you with a notification). We encourage you to review this Privacy Policy regularly to stay informed about our information practices and the choices available to you.</p>
                            <h2 className="text-2xl leading-8 mt-10">CONTENTS</h2>
                            <ul className="mt-4 pl-6 text-xl list-disc space-y-4 font-serif">
                            ...
                            <h3 className="text-xl leading-6 mt-10">COLLECTION OF INFORMATION</h3>
                            <h4 className="text-xl leading-6 mt-10">Information You Provide to Us</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">We collect information you provide directly to us. For example, you share information directly with us when you create an account, fill out a form, submit or post content through our Services, purchase a membership, communicate with us via third-party platforms, request customer support, or otherwise communicate with us. The types of personal information we may collect include your name, display name, username, bio, email address, business information, your content, including your avatar image, photos, posts, responses, and series published by you, and any other information you choose to provide.</p>
                            <p className="text-xl leading-8 mt-9 font-serif">In some cases, we may also collect information you provide about others, such as when you purchase a Prismio membership as a gift for someone. We will use this information to fulfill your request and will not send communications to your contacts unrelated to your request, unless they separately consent to receive communications from us or otherwise engage with us.</p>
                            <p className="text-xl leading-8 mt-9 font-serif">We do not collect payment information through our Services. We rely on third parties to process payments in connection with our Services. Any information you provide to facilitate such a payment is subject to the third-party payment processor’s privacy policy, and we encourage you to review this policy before you provide any information to the payment processor.</p>
                            <h4 className="text-xl leading-6 mt-10">Information We Collect Automatically When You Interact with Us</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">In some instances, we automatically collect certain information, including:</p>
                            <ul className="mt-10 pl-6 text-xl list-disc space-y-4 font-serif">
                                <li>
                                    <strong>Activity Information:</strong>
                                    We collect information about your activity on our Services, such as your reading history and when you share links, follow users, highlight posts, and clap for posts.
                                </li>
                                <li>
                                    <strong>Transactional Information:</strong>
                                    When you purchase a membership, we collect information about the transaction, such as subscription details, purchase price, and the date of the transaction.
                                </li>
                                <li>
                                ...
                                <li>
                                    <strong>Information Collected by Cookies and Similar Tracking Technologies: </strong>
                                    We use tracking technologies, such as cookies and web beacons, to collect information about you. Cookies are small data files stored on your hard drive or in device memory that help us improve our Services and your experience, see which areas and features of our Services are popular, and count visits. Web beacons (also known as “pixel tags” or “clear GIFs”) are electronic images that we use on our Services and in our emails to help deliver cookies, count visits, and understand usage. We also work with third party analytics providers who use cookies, web beacons, device identifiers, and other technologies to collect information about your use of our Services and other websites and applications, including your IP address, web browser, mobile network information, pages viewed, time spent on pages or in mobile apps, and links clicked. This information may be used by Prismio and others to, among other things, analyze and track data, determine the popularity of certain content, deliver content targeted to your interests on our Services, and better understand your online activity. For more information about cookies and how to disable them, see Your Choices below.
                                </li>
                            </ul>

                            <h4 className="text-xl leading-6 mt-10">Information We Collect from Other Sources</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">We obtain information from third-party sources. For example, we may collect information about you from social networks, accounting services providers and data analytics providers. Additionally, if you create or log into your Prismio account through a third-party platform (such as Apple, Facebook, Google, or Twitter), we will have access to certain information from that platform, such as your name, lists of friends or followers, birthday, and profile picture, in accordance with the authorization procedures determined by such platform.</p>

                            <h4 className="text-xl leading-6 mt-10">Information We Derive</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">We may derive information or draw inferences about you based on the information we collect. For example, we may make inferences about your location based on your IP address or infer reading preferences based on your reading history.</p>

                            <h3 className="text-xl leading-6 mt-10">USE OF INFORMATION</h3>
                            <p className="text-xl leading-8 mt-4 font-serif">We use the information we collect to provide, maintain, and improve our Services, which includes publishing and distributing user-generated content, personalizing the posts you see and operating our metered paywall. We also use the information we collect to:</p>
                            <ul className="mt-10 pl-6 text-xl list-disc space-y-4 font-serif">
                            ...
                            <h3 className="text-xl leading-6 mt-10">SHARING OF INFORMATION</h3>
                            <p className="text-xl leading-8 mt-4 font-serif">We share personal information in the following circumstances or as otherwise described in this policy:</p>
                            <ul className="mt-10 pl-6 text-xl list-disc space-y-4 font-serif leading-8">
                                ...
                                <li>We may share personal information if we believe that your actions are inconsistent with our user agreements or policies, if we believe that you have violated the law, or if we believe it is necessary to protect the rights, property, and safety of Prismio, our users, the public, or others.</li>
                            ...
                            <h3 className="text-xl leading-8 mt-10">THIRD-PARTY EMBEDS</h3>
                            <p className="text-xl leading-8 mt-4 font-serif">Prismio does not host some of the content displayed on our Services. Users have the ability to post content that is actually hosted by a third party, but is embedded in our pages (an “Embed”). When you interact with an Embed, it can send information about your interaction to the hosting third party just as if you were visiting the third party’s site directly. For example, when you load a Prismio post page with a YouTube video Embed and watch the video, YouTube receives information about your activity, such as your IP address and how much of the video you watch. Prismio does not control what information third parties collect through Embeds or what they do with the information. This Privacy Policy does not apply to information collected through Embeds. The privacy policy belonging to the third party hosting the Embed applies to any information the Embed collects, and we recommend you review that policy before interacting with the Embed.</p>

                            <h3 className="text-xl leading-8 mt-10">TRANSFER OF INFORMATION TO THE UNITED STATES AND OTHER COUNTRIES</h3>
                            <p className="text-xl leading-8 mt-4 font-serif">Prismio is headquartered in the United States, and we have operations and service providers in the United States and other countries. Therefore, we and our service providers may transfer your personal information to, or store or access it in, jurisdictions that may not provide levels of data protection that are equivalent to those of your home jurisdiction. For example, we transfer personal data to Amazon Web Services, one of our service providers that processes personal information for us in various data center locations across the globe, including those listed here. We will take steps to ensure that your personal information receives an adequate level of protection in the jurisdictions in which we process it.</p>

                            <h3 className="text-xl leading-6 mt-10">YOUR CHOICES</h3>
                            <h4 className="text-xl leading-6 mt-10">Account Information</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">You may access, correct, delete and export your account information at any time by logging into the Services and navigating to the Settings page. Please note that if you choose to delete your account, we may continue to retain certain information about you as required by law or for our legitimate business purposes.</p>

                            <h4 className="text-xl leading-6 mt-10">Cookies</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">Most web browsers are set to accept cookies by default. If you prefer, you can usually adjust your browser settings to remove or reject browser cookies. Please note that removing or rejecting cookies could affect the availability and functionality of our Services.</p>
                            <h4 className="text-xl leading-6 mt-10">Communications Preferences</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">You may opt out of receiving certain communications from us, such as digests, newsletters, and activity notifications, by following the instructions in those communications or through your account’s Settings page. If you opt out, we may still send you administrative emails, such as those about your account or our ongoing business relations.</p>
                            <h4 className="text-xl leading-6 mt-10">Mobile Push Notifications</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">With your consent, we may send push notifications to your mobile device. You can deactivate these messages at any time by changing the notification settings on your mobile device.</p>
                            <h3 className="text-xl leading-6 mt-10">YOUR CALIFORNIA PRIVACY RIGHTS</h3>
                            <p className="text-xl leading-8 mt-4 font-serif">The California Consumer Privacy Act or “CCPA” (Cal. Civ. Code § 1798.100 et seq.) affords consumers residing in California certain rights with respect to their personal information. If you are a California resident, this section applies to you.</p>
                            <div className="p-6 mt-6 border-t border-input/10 border-b">
                                ...
                                <div className="flex justify-center sm:flex-row flex-col sm:gap-0 gap-2 items-center">
                                    <input placeholder="Enter your email" type="text" value="" className="max-w-[280px] h-10 w-full py-2 px-4 rounded-[4px_0_0_4px] bg-gray-100 outline-none" />
                                    <Button variant="default" className="rounded-[0_4px_4px_0]">Subscribe</Button>
                                </div>
                            </div>
                            <p className="text-xl leading-8 mt-10 font-serif">In the preceding 12 months, we have collected the following categories of personal information: identifiers, commercial information, internet or other electronic network activity information, and inferences. For details about the precise data points we collect and the categories of sources of such collection, please see the Collection of Information section above. We collect personal information for the business and commercial purposes described in the Use of Information section above. In the preceding 12 months, we have disclosed the following categories of personal information for business purposes to the following categories of recipients:</p>
                            <figure className="my-14">
                                <picture>
                                    <img alt="" className="bi gl rl c" width="646" height="434" loading="eager" role="presentation" src="https://miro.medium.com/v2/resize:fit:808/0*b9fTh2C5b0m9HrZm" />
                                </picture>
                            </figure>
                            <p className="text-xl leading-8 mt-10 font-serif"><a href="">Link to a text version of this table</a></p>
                            <p className="text-xl leading-8 mt-10 font-serif">Prismio does not sell your personal information.</p>
                            <p className="text-xl leading-8 mt-10 font-serif">Subject to certain limitations, you have the right to (1) request to know more about the categories and specific pieces of personal information we collect, use, and disclose about you, (2) request deletion of your personal information, (3) opt out of any sales of your personal information, if we engage in that activity in the future, and (4) not be discriminated against for exercising these rights. You may make these requests by emailing us at privacy@prismio.com or by completing this webform. We will verify a webform request by asking you to provide identifying information. We will not discriminate against you if you exercise your rights under the CCPA.</p>
                            <p className="text-xl leading-8 mt-10 font-serif">If we receive your request from an authorized agent, we may ask for evidence that you have provided such agent with a power of attorney or that the agent otherwise has valid written authority to submit requests to exercise rights on your behalf. This may include requiring you to verify your identity. If you are an authorized agent seeking to make a request, please contact us.</p>
                            <h3 className="text-xl leading-6 mt-10">ADDITIONAL DISCLOSURES FOR INDIVIDUALS IN EUROPE</h3>
                            <p className="text-xl leading-8 mt-4 font-serif">If you are located in the European Economic Area (“EEA”), the United Kingdom, or Switzerland, you have certain rights and protections under applicable law regarding the processing of your personal data, and this section applies to you.</p>
                            <h4 className="text-xl leading-6 mt-10">Legal Basis for Processing</h4>
                            <p className="text-xl leading-8 mt-4">When we process your personal data, we will do so in reliance on the following lawful bases:</p>
                            <ul className="mt-10 pl-6 text-xl list-disc space-y-4 font-serif leading-8">
                            ...
                            <h4 className="text-xl leading-6 mt-10">Data Retention</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">We store personal data associated with your account for as long as your account remains active. If you close your account, we will delete your account data within 14 days. We store other personal data for as long as necessary to carry out the purposes for which we originally collected it and for other legitimate business purposes, including to meet our legal, regulatory, or other compliance obligations.</p>
                            <h4 className="text-xl leading-6 mt-10">Data Subject Requests</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">Subject to certain limitations, you have the right to request access to the personal data we hold about you and to receive your data in a portable format, the right to ask that your personal data be corrected or erased, and the right to object to, or request that we restrict, certain processing. To exercise your rights:</p>
                            <ul className="mt-10 pl-6 text-xl list-disc space-y-4 font-serif leading-8">
                                <li>If you sign up for a Prismio account, you may at any time request an export of your personal information from the Settings page, or by going to Settings and then selecting Account within our app.</li>
                                ...
                                <li>You may withdraw consent by deleting your account at any time through the Settings page, or by going to Settings and then selecting Account within our app (except to the extent Prismio is prevented by law from deleting your information).</li>
                                <li>You may object at any time to the use of your personal data by contacting privacy@prismio.com.</li>
                            </ul>
                            <h4 className="text-xl leading-6 mt-10">Questions or Complaints</h4>
                            <p className="text-xl leading-8 mt-4 font-serif">If you have a concern about our processing of personal data that we are not able to resolve, you have the right to lodge a complaint with the Data Protection Authority where you reside. Contact details for your Data Protection Authority can be found using the links below:</p>
                            <ul className="mt-10 pl-6 text-xl list-disc space-y-4 font-serif leading-8">
                                <li>For individuals in the EEA: <br />
                                    https://edpb.europa.eu/about-edpb/board/members_en
                                </li>
                                <li>
                                    For individuals in the UK: <br />
                                    https://ico.org.uk/global/contact-us/
                                </li>
                                <li>
                                    For individuals in Switzerland: <br />
                                    https://www.edoeb.admin.ch/edoeb/en/home/the-fdpic/contact.html
                                </li>
                            </ul>
                            <h3 className="text-xl leading-6 mt-10">CONTACT US</h3>
                            <p className="text-xl leading-8 mt-4 font-serif">If you have any questions about this Privacy Policy, please contact us at privacy@prismio.com.</p>
                            <p className="text-xl leading-8 mt-10 font-serif">If you are from the EEA or the United Kingdom and have questions about this Privacy Policy, please contact us at privacy@prismio.com or our privacy representatives as follows:</p>
                            <h4 className="text-xl leading-6 mt-10">Privacy representative for EEA</h4>
                            <address className="text-xl leading-8 mt-4 font-serif not-italic">
                            ...
                            <Link href="" className="mt-10 underline text-xl inline-block">here</Link>
                        </div>
                    </div>
                </article>

                <div className="max-w-[680px] px-4 mb-7 mt-4 mx-auto">
