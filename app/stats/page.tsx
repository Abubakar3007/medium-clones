  ...
  return (
    <Layout>
      <div className="md:px-16 px-6 py-12 mx-auto">
        <h1 className="md:text-[42px] text-3xl font-bold mb-10 animate-fade-in">Stats</h1>
        ...
        {activeTab === "Stories" && (
          <>
            {/* Monthly section */}
            <div className="mb-10">
              <div className="flex md:items-center justify-between mb-3 md:flex-row flex-col gap-5">
                <h2 className="text-2xl font-bold">Monthly</h2>
                <select
                  value={selectedMonth}
                  onChange={(e) => setSelectedMonth(e.target.value)}
                  className="border border-divider rounded-3xl md:max-w-44 w-full px-5 h-[38px] appearance-none py-1.5 text-sm bg-background cursor-pointer"
                >
                  {months.map((m) => (
              ...
              <div className="flex gap-10 mb-16 flex-wrap">
                {[
                  ...
                  <div key={stat.label} className="text-center">
                    <p className="md:text-[42px] text-2xl font-black">{stat.value}</p>
            ...
            <div className="overflow-hidden">
              <div className="flex md:items-center justify-between mb-3 md:flex-row flex-col gap-5">
                ...
                <select className="border border-divider rounded-3xl px-5 py-1.5 h-9 md:max-w-40 w-full cursor-pointer text-sm bg-background appearance-none">
              ...
              <div className="overflow-x-auto">
                <table className="min-w-[800px] w-full text-sm">
                  <thead>
                    <tr className="w-full">
                      <th className="text-left pt-3 pb-14 font-medium text-neutral-500 md:min-w-full min-w-[300px]">Story</th>
        ...
        {activeTab === "Audience" && (
          <div>
            ...
            <p className="text-xs font-light text-neutral-500 md:mb-16 mb-8">February 6, 2026 – Today (UTC) · Updated daily</p>

            {/* total audience in number */}
            <div className="flex md:gap-16 gap-6 md:my-12 my-8">
              <div>
                <h3 className="font-black md:text-[42px] text-2xl mb-3">0</h3>
                <div>
                  <p className="md:text-base leading-6">Followers <Info className="h-3 w-3 inline-block ml-1" /></p>
                  <p className="md:text-base leading-6"><span>0</span> {" "} from last month</p>
                </div>
              </div>
              ...
              <div>
                <h3 className="font-black md:text-[42px] text-2xl mb-3">0</h3>
                <div>
                  <p className="md:text-base leading-6">Email Subscribers <Info className="h-3 w-3 inline-block ml-1" /></p>
                  <p className="md:text-base leading-6"><span>0</span> {" "} from last month</p>
                </div>
              </div>
            </div>
